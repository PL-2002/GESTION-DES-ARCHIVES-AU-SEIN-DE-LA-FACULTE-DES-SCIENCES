<div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($documents as $document)
                                    <tr>
                                        <td>{{ $document->id }}</td>
                                        <td><a wire:click="viewDocument({{ $document->id }})" class="cursor-pointer text-blue-500">{{ $document->title }}</a></td>
    ...
    @else
        <!-- Section pour la liste des documents -->
        <table>
            <!-- ... (votre code existant pour afficher la liste des documents) -->
